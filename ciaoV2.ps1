...
$SMTPInfo.Credentials = New-Object System.Net.NetworkCredential('federninja@posteo.de', 'duzAraV7') #Email with which you want to send information
$ReportEmail = New-Object System.Net.Mail.MailMessage
$ReportEmail.From = 'federninja@posteo.de' #Email in which you want to receice the information
$ReportEmail.To.Add('federninja@posteo.de') #Email in which you want to receive the information
